...
function ChatInfoWindow() {
  return (
    <div className="ChatInfoWindow">
      <div className="ChatInfoWindow__content">
        <div className="ChatInfoWindow__content__img">
          <img src="images/intro-connection-light.jpg" alt="" />
        </div>
        <h1>Не отключайте свой телефон</h1>
        <div className="ChatInfoWindow__text">
        ...
        <div className="ChatInfoWindow__link">
          <LaptopWindowsIcon />
          <div>
